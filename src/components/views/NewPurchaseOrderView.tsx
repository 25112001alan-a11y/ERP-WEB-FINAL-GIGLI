...
import { ViewPath, Supplier } from '../../types';
...
export const NewPurchaseOrderView: React.FC<NewPurchaseOrderViewProps> = ({ suppliers, onNavigate }) => {
  const [selectedSupplier, setSelectedSupplier] = useState('');
  const [lines, setLines] = useState([
    { id: '1', sku: 'SKU-001', qty: 10, unitCost: 120 },
    { id: '2', sku: 'SKU-002', qty: 5, unitCost: 450 },
  ]);
  ...
  const addLine = () => {
    setLines((prev) => [...prev, { id: Date.now().toString(), sku: '', qty: 1, unitCost: 0 }]);
  };
    ...
    <div className="flex flex-col w-full h-full p-lg gap-lg font-body-md text-on-surface">
      <header className="flex items-center justify-between pb-sm border-b border-outline-variant/30">
        ...
        <div className="flex gap-sm">
          ...
          <button
            onClick={handleSave}
            className="px-md py-sm rounded-lg bg-primary text-on-primary font-label-md text-label-md uppercase tracking-wider hover:opacity-90 transition-opacity shadow-md flex items-center gap-sm cursor-pointer"
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-md relative z-10">
                ...
                <div className="flex flex-col gap-xs">
                  ...
                  <input
                    type="text"
                    disabled
                    value={selectedSupplier ? 'contacto@proveedor.com' : 'Seleccione un proveedor primero'}
                          ...
                          <td className="py-md px-md">
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                setLines((prev) => prev.map((l) => (l.id === line.id ? { ...l, sku: val } : l)));
                              }}
                              placeholder="Buscar SKU o nombre..."
                              className="w-full bg-transparent border-b border-outline-variant/30 focus:border-primary focus:outline-none py-xs"
                            />
                          </td>
                          <td className="py-md px-md">
                            <input
          ...
          <div className="lg:col-span-1 space-y-lg flex flex-col h-full">
            <section className="bg-surface-container-lowest p-lg rounded-xl shadow-sm border border-outline-variant/20">
              ...
              <div className="space-y-md">
                <div className="flex flex-col gap-xs">
                  ...
                  >
                    <option value="main">Almacén Principal (Matriz)</option>
                    <option value="north">Centro de Distribución Norte</option>
                    <option value="south">Bodega Sur</option>
                  </select>
                </div>
              </div>
            </section>
            ...
            <section className="bg-primary text-on-primary p-lg rounded-xl shadow-md border-t-4 border-secondary-container mt-auto relative overflow-hidden">
              ...
              <div className="space-y-md font-body-md">
                ...
                <div className="flex justify-between items-center border-b border-on-primary/10 pb-sm">
                  <span className="text-on-primary/70">Impuestos (16%)</span>
